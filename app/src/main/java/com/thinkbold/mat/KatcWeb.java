...
public class KatcWeb extends AppCompatActivity {
    WebView webView;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_katc_web);
        webView = findViewById(R.id.katcWeb);
        progressBar = findViewById(R.id.progressBar);

        webView.setWebViewClient(new KatcWeb.WebViewClient());
    ...
    public void katcButton(View view) {
        switch (view.getId()){
            case R.id.aboutview:
