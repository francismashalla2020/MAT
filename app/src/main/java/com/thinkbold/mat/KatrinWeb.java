...
public class KatrinWeb extends AppCompatActivity {
    WebView webView;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_katrin_web);

        webView = findViewById(R.id.katrinWeb);
        progressBar = findViewById(R.id.progressBar);

        webView.setWebViewClient(new KatrinWeb.WebViewClient());
    ...
    public void katrinButton(View view) {
        switch (view.getId()){
            case R.id.aboutview:
