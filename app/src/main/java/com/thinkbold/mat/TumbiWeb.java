...
public class TumbiWeb extends AppCompatActivity {
    WebView webView;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_tumbi_web);
        webView = findViewById(R.id.tumbiWeb);
        progressBar = findViewById(R.id.progressBar);

        webView.setWebViewClient(new TumbiWeb.WebViewClient());
    ...
    public void tumbiButton(View view) {
        switch (view.getId()){
            case R.id.aboutview:
