...
public class NSIweb extends AppCompatActivity {
    WebView webView;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_n_s_iweb);
        webView = findViewById(R.id.nsiWeb);
        progressBar = findViewById(R.id.progressBar);

        webView.setWebViewClient(new NSIweb.WebViewClient());
    ...
    public void nsiButton(View view) {
        switch (view.getId()){
            case R.id.aboutview:
