...
public class MubondoWeb extends AppCompatActivity {
    WebView webView;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_mubondo_web);
        webView = findViewById(R.id.mubondoWeb);
        progressBar = findViewById(R.id.progressBar);

        webView.setWebViewClient(new MubondoWeb.WebViewClient());
    ...
    public void mubondoButton(View view) {
        switch (view.getId()){
            case R.id.aboutview:
