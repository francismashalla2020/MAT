...
public class MtwaraWeb extends AppCompatActivity {
    WebView webView;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_mtwara_web);
        webView = findViewById(R.id.mtwaraWeb);
        progressBar = findViewById(R.id.progressBar);

        webView.setWebViewClient(new MtwaraWeb.WebViewClient());
    ...
    public void mtwaraButton(View view) {
        switch (view.getId()){
            case R.id.aboutview:
