...
public class MarukuWeb extends AppCompatActivity {
    WebView webView;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_maruku_web);

        webView = findViewById(R.id.katrinWeb);
        progressBar = findViewById(R.id.progressBar);

        webView.setWebViewClient(new MarukuWeb.WebViewClient());
    ...
    public void marukuButton(View view) {
        switch (view.getId()){
            case R.id.aboutview:
