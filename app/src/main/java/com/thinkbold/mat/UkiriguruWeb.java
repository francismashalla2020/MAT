...
public class UkiriguruWeb extends AppCompatActivity {
    WebView webView;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_ukiriguru_web);
        webView = findViewById(R.id.ukiWeb);
        progressBar = findViewById(R.id.progressBar);
        webView.setWebViewClient(new UkiriguruWeb.WebViewClient());
    ...
    public void ukiButton(View view) {
        switch (view.getId()){
            case R.id.aboutview:
