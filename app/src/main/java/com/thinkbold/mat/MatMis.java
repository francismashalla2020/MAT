...
public class MatMis extends AppCompatActivity {
    WebView webView;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_mat_mis);
        webView = findViewById(R.id.misWeb);
        progressBar = findViewById(R.id.progressBar);
        webView.setWebViewClient(new MatMis.WebViewClient());
        webView.getSettings().setJavaScriptEnabled(true);

        webView.loadUrl("http://ibold.africa/matiuyole");
    }
    ...
    public void misButton(View view) {
        switch (view.getId()){
            case R.id.aboutview:
