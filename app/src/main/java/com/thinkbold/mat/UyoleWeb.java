...
public class UyoleWeb extends AppCompatActivity {
    WebView webView;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_uyole_web);
        webView = findViewById(R.id.uyoleWeb);
        progressBar = findViewById(R.id.progressBar);
        webView.setWebViewClient(new UyoleWeb.WebViewClient());
    ...
    public void uyoleButton(View view) {
        switch (view.getId()){
            case R.id.aboutview:
